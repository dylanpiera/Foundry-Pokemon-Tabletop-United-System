...
export class ActorGenerator {
    ...
    async PrepareArt(imgSrc, imgExt = ".webp") {
        ...
        let imgPath = await GetSpeciesArt(this.species.data, imgSrc, imgExt, this.actor.system.shiny, false, (this.actor.system.gender ?? this.system.gender ?? "").toLowerCase().includes("female"), ".webm", this.actor.system.nature.value);
