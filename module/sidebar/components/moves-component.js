...
export default class MovesList extends Component {
    ...
    PrepareMoveSystem(moveSystem, actorData, targetIds) {
        ...
        moveSystem.stab = moveSystem.owner?.type && (moveSystem.owner.type[0] == moveSystem.type || moveSystem.owner.type[1] == moveSystem.type || moveSystem.owner.type[2] == moveSystem.type);
