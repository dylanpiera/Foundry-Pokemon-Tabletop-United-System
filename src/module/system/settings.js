...
export function registerSettings() {
    ...
    game.settings.register("ptu", "defaultPokemonImageExtension", {
        name: "Default Pokemon Image Extension",
        hint: "The file extension of the images withing the default pokemon image directory.",
        scope: "world",
        config: true,
        type: String,
        default: ".webp",
    ...
    game.settings.register("ptu", "defaultPokemonImageSlugTypeName", {
        name: "Pokemon Image Name Type",
        hint: "Whether the images are based on name (checked) or dex number (unchecked)",
        scope: "world",
        config: true,
        type: Boolean,
        default: false,
    ...
    // Move Master Settings
    {
        ...
        game.settings.register("ptu", "removeExpiredEffects", {
            name: "Remove expired effects",
            hint: "Remove expired effects from actors.",
            scope: "world",
            config: true,
            type: Boolean,
            default: false
        ...
        game.settings.register("ptu", "autoExpireEffects", {
            name: "Automatically expire effects",
            hint: "Automatically expire effects after their duration has passed.",
            scope: "world",
            config: true,
            type: Boolean,
            default: true
        ...
        game.settings.register("ptu", "failAttackIfOutOfRange", {
            name: "Fail attack if out of range",
            hint: "Automatically fail attacks if the target is out of range.",
            scope: "world",
            config: true,
            type: Boolean,
            default: true
        ...
        game.settings.register("ptu", "alwaysShowCrits", {
            name: "Always show crits",
            hint: "Always show crits in the chat even if no crit was rolled.",
            scope: "world",
            config: true,
            type: Boolean,
            default: false
